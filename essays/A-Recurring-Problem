...
“Never be afraid to ask questions” is a phrase I’ve always heard in classrooms to help those that don’t understand to seek help when they need it. But sometimes the questions aren’t the most useful for discussion, and are probably better off not being asked. Those questions generally relate to topics that the asker should already know, such as when a professor assigns a reading about Shakespeare’s life. A question you should probably be in fact afraid about asking is, “Who is Shakespeare?” Maybe your professor will act generous and give you an answer, but on other mediums like online forums or emails, the potential responder will most likely view these simple and easy-to-look-up questions as a waste of their time. Thus, we shouldn’t be afraid to ask questions, but we should put thought and effort into our question to show potential responders that you aren’t wasting their time with something you could have figured out yourself.

## Effort leads to more effort

It’s imperative to ask smart questions, because it not only helps others narrow down what your solution is, you may also find yourself finding your own solution when trying to figure out how to ask a smart question. We don’t want to just ask some silly question like, “Why doesn’t my code work?” and expect other people to baby us and give us the solution. When deciding what to ask, we can narrow the scope of our code to isolate the problem, which can lead us toward finding our own solution. And even then, the internet is there for us to search up solutions for our problems before we even ask a question. We learn how to find solutions via searching the internet (which should almost be the first thing you do when you have a question, hence the usually sassy remark, “Just Google it”). For example, [this developer posted on StackOverflow](https://stackoverflow.com/questions/46701773/stop-listview-selected-item-from-changing-until-button-pressed) a question for a possible solution to his problem. The developer removes certain lines from his code to isolate where the problem stems from, and then gives out all pertaining files to give responders the information to give him a solution. Not only does someone give him a hefty solution to his problem, the developer even manages to find his own solution after reviewing his code.
